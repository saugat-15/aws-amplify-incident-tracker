      ...
      <div className="w-full max-w-md">
        ...
        <div className="relative w-full">
          ...
          <div className="border border-gray-300 rounded-full bg-white p-2 flex items-center">
            <span className="bg-[#A27B5C] text-[#e3fcd6] px-4 py-2 rounded-full text-sm">
              Choose File
            </span>
        ...
        <div className="space-y-2 mt-4">
          <button
            ...
            className={`w-full p-3 rounded-full text-center transition-colors ${
              loading || !selectedFile
                ? "bg-[#A27B5C] cursor-not-allowed text-white"
                : "bg-[#e3fcd6] hover:bg-[#A27B5C] text-white"
            }`}
          >
