...
const Header: React.FC<HeaderProps> = ({ title, onSignOut }) => {
  ...
  return (
    <header className="p-2 shadow-md sticky top-0 left-0 z-50 bg-[#2C3930] w-screen">
      <div className="container mx-auto px-4 md:px-6 py-3 flex items-center justify-between bg-[#3F4F44] rounded-full relative">
        {/* Mobile Menu Button */}
        <button
          onClick={() => setIsMenuOpen(!isMenuOpen)}
          className="md:hidden text-white p-2 hover:bg-[#A27B5C] rounded-full transition-colors"
